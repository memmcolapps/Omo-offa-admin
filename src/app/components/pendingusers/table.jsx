  ...
  return data.length > 0 ? (
    ...
    <div className="flex justify-center items-center">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-800">No Pending Users</h1>
        <p className="text-gray-600">
          There are no pending users at the moment. Please check back later.
        </p>
      </div>
    </div>
  );
